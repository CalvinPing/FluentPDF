...
export function ImageFileRow({
  ...
  return (
    ...
    >
      ...
      {/* eslint-disable-next-line @next/next/no-img-element -- ephemeral local blob: URL for a
          user-uploaded file, not a static/remote asset next/image is built to optimize. */}
      <img
        src={file.previewUrl}
        alt=""
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="text-xs text-foreground-subtle">Page {index + 1}</p>
      </div>
